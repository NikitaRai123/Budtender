...
//    static let host              = "http://18.218.198.255:8000"
    ...
    struct Name {
       ...
       //MARK: HOME SCREEN
        ...
        static let productGuestCategoryList    = "getGuestCategorylisting"
        static let subCategoryList        = "getSubcategorylisting"
        static let subCategoryGuestList        = "getGuestSubcategorylisting"
        ...
        //MARK: ADD PICKUP DETAILS
        static let userPickupdetails = "userPickupdetails"
        static let createPickup = "createPickup"
    }

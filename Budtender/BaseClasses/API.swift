...
//    static let host              = "http://18.218.198.255:8000"
    ...
    struct Name {
        ...
        static let changePass             = "change-password.php"
        static let socialLogin            = "socialLogIn.php"
        static let editProfile            = "edit-profile.php"//"webservice/editProfile.php"
        static let getProfile             = "get-profile.php"
       ...
       //MARK: HOME SCREEN
        ...
        static let friendDetail           = "getFriendDetail.php"
        static let addFriend              = "friendUnfriend.php"
        static let friendList             = "myFriendListing.php"
        static let blockFriend            = "userBlockUnblock.php"

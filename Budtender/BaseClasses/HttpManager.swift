...
//                }
    ...
    static public func uploadingMultipleTaskWithoutToken(_ url:String, params: [String:Any], profilePhoto: PickerData?, coverPhoto: PickerData?, receivedResponse: @escaping(_ succeeded:Bool, _ response:[String:Any], _ data:Data?) -> ())
    {
        let boundary:NSString = "----WebKitFormBoundarycC4YiaUFwM44F6rT"
        let body:NSMutableData = NSMutableData()
        let paramsArray = params.keys
